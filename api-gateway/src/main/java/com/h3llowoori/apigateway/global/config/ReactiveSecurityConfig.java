package com.h3llowoori.apigateway.global.config;

import com.h3llowoori.apigateway.global.security.JwtReactiveAuthenticationManager;
import com.h3llowoori.apigateway.global.security.JwtReactiveSecurityContextRepository;
import com.h3llowoori.apigateway.global.security.JwtUtil;
...
public class ReactiveSecurityConfig {
    ...
    public MapReactiveUserDetailsService userDetailsService() {
        UserDetails user = User
                .withUsername("hello").password(passwordEncoder().encode("world")).roles("USER")
                .build();
